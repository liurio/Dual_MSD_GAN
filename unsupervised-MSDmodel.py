...
class DualNet(object):
    ...
    ###  define graphs
        ...
        '''if feature_loss==True:
               self.Ad_feature_match_loss=tf.reduce(tf.abs(self.Ad_feature_fake-self.Ad_feature_real))
               self.Bd_feature_match_loss=tf.reduce(tf.abs(self.Bd_feature_fake-self.Bd_feature_real))
               self.Ad_loss = self.Ad_loss + self.Ad_feature_match_loss
               self.Bd_loss = self.Bd_loss + self.Bd_feature_match_loss
        '''
