...
parser.add_argument('--lambda_A', dest='lambda_A', type=float, default=10.0, help='# weights of A recovery loss')
parser.add_argument('--lambda_B', dest='lambda_B', type=float, default=10.0, help='# weights of B recovery loss')
